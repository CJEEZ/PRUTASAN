            ...
            <div class="overflow-x-auto rounded-lg bg-white shadow">
                <table class="w-full divide-y divide-gray-200 text-sm">
                    <thead class="divide-y border-b border-gray-200 bg-gray-50">
                        <tr>
                            <th class="px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase sm:px-6 sm:py-4">Product Name</th>
                            <th class="hidden px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase sm:table-cell sm:px-6 sm:py-4">Category</th>
                            <th class="px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase sm:px-6 sm:py-4">Price</th>
                            <th class="hidden px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase sm:table-cell sm:px-6 sm:py-4">Stock</th>
                            <th class="hidden px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase lg:table-cell lg:px-6 lg:py-4">Unit</th>
                            <th class="px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase sm:px-6 sm:py-4">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        @forelse($products as $product)
                            <tr class="transition hover:bg-gray-50">
                                ...
                                <td class="hidden px-3 py-3 text-xs text-gray-600 sm:table-cell sm:px-6 sm:py-4">
                                    {{ $product->category->name ?? 'N/A' }}
                                </td>
                                <td class="px-3 py-3 text-xs font-semibold text-orange-600 sm:px-6 sm:py-4">
                                    ₱{{ number_format($product->price, 2) }}
                                </td>
                                <td class="hidden px-3 py-3 text-xs sm:table-cell sm:px-6 sm:py-4">
                                ...
                                <td class="hidden px-3 py-3 text-xs text-gray-600 lg:table-cell lg:px-6 lg:py-4">
                                    {{ $product->unit }}
                                </td>
                                <td class="px-3 py-3 text-xs space-x-1 sm:px-6 sm:py-4 sm:space-x-2">
